            ...
            <div className="md:w-1/2">
              ...
              <div className={`mt-8 transition-all duration-500 ${animatePlayer ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="bg-gray-800 p-4 rounded-lg text-center border border-green-600/30">
                  ...
                  <div className="bg-gray-800 p-4 rounded-lg text-center border border-orange-600/30">
                  ...
                  <div className="bg-gray-800 p-4 rounded-lg text-center border border-red-600/30">
